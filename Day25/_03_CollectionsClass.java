...
public class _03_CollectionsClass {
    ...
    public static void main(String[] args) {
        ...
        Collections.addAll(treeSet , 5,1,2,8,2,4);
        System.out.println(treeSet);

        // sort() -- sort the list in ascending order -- Just for list
        // ascending = artan -- yukselen = kucukten buyuge siraliyor
        Collections.sort(numbersList);
        System.out.println("ArrayList after using sort method: " + numbersList);

        // reverseOrder() -- sorts the elements in descending order (reverseOrder) -- Just for list either
        // descenting = azalaln -- buyukten kucure siralama
