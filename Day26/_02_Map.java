...
public class  _02_Map {
    ...
    public static void main(String[] args) {
        ...
        salaries.put("John", 135_000); // This is duplicated key, we cannot duplicate keys in MAP! -> it's will updating john value will be 135_000
        ...
        salaries.putIfAbsent("Rita", 300_000); // Emily was exist --> didnt update value
        System.out.println(salaries);
